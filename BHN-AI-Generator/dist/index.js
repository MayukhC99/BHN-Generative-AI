...
var _uploadClient = require("@uploadcare/upload-client");
    ...
    return /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            console.log(id);
            file = dataURLtoFile("data:text/plain;base64,".concat(_base["default"][id]), "aiImageFile".concat(id, ".txt"));
            _context.next = 4;
            return (0, _uploadClient.uploadDirect)(file, {
